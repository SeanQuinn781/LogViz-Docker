...
# TODO, split up static files between two services
# api will have templates for uploading, data service will have static map
# for now, just share the static files in the api service between both services 
app = Flask(__name__)
app.config['APPLICATION_ROOT'] = '/var/www/html/LogViz-K8/lv_api_service/app'
app.config['SECRET_KEY'] = 'hh_jxc(80L"Fccodf98)fxec]|'
app.config['UPLOAD_DIR'] = '/var/www/html/LogViz-K8/lv_api_service/app/static/data/'
app.config['ASSET_DIR'] = '/var/www/html/LogViz-K8/lv_api_service/app/static/mapAssets/'
app.config['CLEAN_DIR'] = '/var/www/html/LogViz-K8/lv_api_service/app/static/cleanData/'
app.config['HTML_DIR'] = '/var/www/html/LogViz-K8/lv_api_service/app/static/'
