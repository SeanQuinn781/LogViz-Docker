...
def logViz():
    ...
    class LogViz(object):
        ...
        def rasterizeData(self, resLat=200, resLong=250):
            ...
            with open(self.analysis, "r") as json_file:
                ...
                # center squares
                raster = []
                # creating raster with log line data and information object to
                # count total IPs and calculate data point size based on the amount
    ...
    # create lists of all log files for processing & generating maps
